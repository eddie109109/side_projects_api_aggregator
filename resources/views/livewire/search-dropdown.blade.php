<div  class="relative" x-data="{ isVisible: true }" x-on:click.away="isVisible= false">    <!-- for the search icon -->
        {{-- the search var will get passed to the controller  --}}
        <div> 
            <input  x-on:keydown="isVisible= true" wire:model.debounce.300ms="search" type="text" class="bg-gray-800 text-sm rounded-full focus:outline-none focus:shadow-outline w-64 px-3 pl-8 py-1" placeholder="Search..."> 
        ...
        {{-- <button x-on:click="isVisible = false">Toggle Dropdown</button> --}}
